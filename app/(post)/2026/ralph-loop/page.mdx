export const metadata = {
  ...
  openGraph: {
    title: 'Ralph Loop: The Night Shift You Don\'t Pay For',
    description: 'Something weird is happening in the repos of a small but growing group of developers. They\'re pushing commits at 3am — because they\'re asleep. Their agent isn\'t.',
    images: [{ url: '/og/ralph-loop' }]
  }
}
