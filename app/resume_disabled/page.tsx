      ...
      <div className="flex items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 text-black dark:text-white hover:bg-gray-200 dark:hover:bg-[#313131] active:bg-gray-300 dark:active:bg-[#242424] rounded-sm px-3 py-2 transition-[background-color]"
          >
