...
*See also: "Superpowers: The Skill System That Makes Claude Unstoppable" — for when you want skills to persist in context. GSD — for when you want to avoid context entirely.*
