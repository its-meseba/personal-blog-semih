export const metadata = {
  ...
  openGraph: {
    title: 'The Identity Crisis of AI Agents',
    description: 'The security hole no one is talking about.',
    images: [{ url: '/og/agent-identity-crisis' }]
  }
}
...
*See also: [Get Shits Done: The Anti-Enterprise AI Workflow](https://www.mehmetsemihbabacan.com/2026/get-shit-done) — for how to build AI systems the right way.*