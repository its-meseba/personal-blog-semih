export const metadata = {
  ...
  openGraph: {
    title: 'Get Shits Done: The Anti-Enterprise AI Workflow',
    description: 'Building without the enterprise theater.',
    images: [{ url: '/og/get-shit-done' }]
  }
}
...
*See also: [Superpowers: The Skill System That Makes Claude Unstoppable](https://www.mehmetsemihbabacan.com/2026/superpowers-skill) — for when you want skills to persist in context. [Soul.md](https://www.mehmetsemihbabacan.com/2026/soul-md) — for the identity file approach.*
